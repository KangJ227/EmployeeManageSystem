...
public class DeleteDepartmentDialog extends JDialog implements ActionListener{
    /**
     *弹出删除部门的窗口
     */

    JButton delete,exit;
    JTextField jtf1; //输入要删除部门的部门号
    JPanel p1,p2;

    public DeleteDepartmentDialog(JFrame owner){
        super(owner,"删除部门信息");
        ...
        if(e.getSource()==delete){
            ...
            if(jtf1.getText().equals("")){
                ...
                try{
                    ...
                    String s = "delete from department where dno='"+id+"'"; //执行的SQL语句
