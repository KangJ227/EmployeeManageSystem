...
public class DeleteSalaryDialog extends JDialog implements ActionListener{
    /**
     *弹出删除薪资的窗口
     */
    ...
    public DeleteSalaryDialog(JFrame owner){
        super(owner,"删除薪资信息");
        ...
        if(e.getSource()==delete){
            ...
            if(jtf1.getText().equals("")){
                ...
                try{
                    ...
                    String s = "delete from salary where eno='"+id+"'"; //执行的SQL语句
                    int i = sql.executeUpdate(s);
                    if(i==0){
                        JOptionPane.showMessageDialog(null,"不存在该数据！");
                    }else{
                        JOptionPane.showMessageDialog(null,"删除员工薪资成功！");
