...
public class UpdateAttendanceDialog extends JDialog implements ActionListener{
    ...
    public UpdateAttendanceDialog(JFrame owner){
        super(owner,"员工考勤记录修改");
        ...
        if(e.getSource()==save){
            ...
            if(id.getText().equals("")){
                ...
                try{
                    ...
                    String s = "UPDATE attendance SET eno='"+ID+"',Attend='"+ATTENDNUM+"',AskLeave='"+ASKLEAVENUM+"',Absent='"+ABSENTNUM+"' where eno='"+ID+"'";

                    sql.executeUpdate(s);
                    sql.close();
                    con.close();
                    JOptionPane.showMessageDialog(null, "员工考勤记录修改成功");
